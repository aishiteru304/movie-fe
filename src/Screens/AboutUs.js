            ...
            <div className='min-height-screen container mx-auto px-2 my-6'>
                ...
                <div className='xl:py-20 py-10 px-4'>
                    <div className='grid grid-flow-row xl:grid-cols-2 gap-4 xl:gap-16 items-center'>
                        <div>
                            <h3 className='text-xl lg:text-3xl mb-4 font-semibold'>Welcome to our Netflixo</h3>
                            ...
                            <div className='grid md:grid-cols-2 gap-6 mt-8'>
                                <div className='p-8 bg-dry rounded-lg'>
                                    ...
                                    <p className='mb-0 text-text leading-7 text-sm'>Lorem Ipsum is simply dummy text of the printing</p>
                                </div>
                                <div className='p-8 bg-dry rounded-lg'>
                        ...
                        <img alt='' src='/img/about.jpg' className='w-full xl:block hidden h-header rounded-lg object-cover'></img>
                    </div>
                </div>
            </div>
        </Layout>
