...
export default function MovieInfo({ movie }) {
    return (
        <div className='w-full xl:h-screen relative text-white'>
            <img alt='' src={movie.titleImage} className='w-full hidden xl:inline-block h-full object-cover'></img>
                    ...
                    <div className='col-span-2 md:grid grid-cols-5 gap-4 items-center'>
                        ...
                        <div className='col-span-2 md:mt-0 mt-2 flex justify-end'>
                            <button className='md:w-1/4 w-full relative flex-colo bg-subMain hover:bg-transparent border-2 border-subMain transitions md:h-64 h-20 rounded font-medium'>
                                <a href='/img/movie.mp4' download={true} className='flex-rows gap-6 text-md uppercase tracking-widest absolute md:rotate-90'>
                                    {'Download'}
